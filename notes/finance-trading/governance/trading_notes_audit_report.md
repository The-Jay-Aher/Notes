...
| --- | --- | --- | --- | --- | --- | --- |
| `notes/finance-trading/foundations/Fundamental Analysis.md` | Fundamental analysis, valuation, accounting, stock/index/futures/options bridge | Fundamental research and trade filtering | Stocks, indexes, futures, options | Medium to long term; positional bridge | Strong reference, incomplete as execution system | General theory, risk notes, templates |
| `notes/finance-trading/strategies/Positional Trader.md` | Positional trading guide | Trend, breakout, retest, relative strength, event-driven | Mostly stocks, with futures/options discussion | Days to months | Decent educational guide, unclear as validated strategy | Trade rules, risk rules, psychology, routines |
| `notes/finance-trading/strategies/Probabilistic Trading Guide.md` | Expectancy, R-multiples, trade scoring, manual decision process | Cross-strategy risk and decision framework | General trading | Intraday/swing/positional concepts | Strong process note, not evidence | Risk rules, trade process, journal logic |
| `notes/finance-trading/foundations/Financial Jargon Glossary.md` | Finance and trading terminology | Not a strategy | Stocks, futures, options, macro, commodities | Not applicable | Strong educational reference | General theory and definitions |
| `notes/finance-trading/study-plans/aws_saa_trading_bot_plan_checklist.md` | AWS SAA plus trading bot checklist | Bot planning, paper trading, backtest idea | Unspecified trading bot | Project timeline | Useful DevOps checklist, trading readiness unclear | Project checklist |
| `notes/finance-trading/study-plans/aws_saa_trading_bot_plan_checklist_v2.md` | AWS SAA plus trading bot plus Terraform checklist | Bot planning, paper trading, backtest idea | Unspecified trading bot | Project timeline | Useful DevOps checklist, trading readiness unclear | Project checklist |
| `personal/planning/Todo's.md` | General todo list | Option selling mode idea | Options | Unspecified | Contains one high-risk unresolved trading idea | Todo item |
...
- `notes/devops-cloud/aws-solutions-architect-associate/Images/EBS Volume.png`
- `notes/devops-cloud/aws-solutions-architect-associate/Images/spot-instance-termination.png`
...
- `notes/finance-trading/foundations/Fundamental Analysis.md` has a serious treatment of accounting, valuation, cash flow, red flags, point-in-time data, and derivative risk.
- `notes/finance-trading/strategies/Positional Trader.md` correctly distinguishes positional trading from investing and intraday trading.
- `notes/finance-trading/strategies/Probabilistic Trading Guide.md` correctly focuses on R-multiples, expected value, and sample size.
...
Source: `notes/finance-trading/strategies/Positional Trader.md`, `notes/finance-trading/strategies/Probabilistic Trading Guide.md`
...
Source: `notes/finance-trading/strategies/Positional Trader.md`, `notes/finance-trading/foundations/Financial Jargon Glossary.md`
...
Source: `notes/finance-trading/foundations/Fundamental Analysis.md`, `notes/finance-trading/strategies/Positional Trader.md`, `personal/planning/Todo's.md`
...
Source: `notes/finance-trading/study-plans/aws_saa_trading_bot_plan_checklist.md`, `notes/finance-trading/study-plans/aws_saa_trading_bot_plan_checklist_v2.md`
...
- `notes/finance-trading/strategies/Positional Trader.md`
- `notes/finance-trading/workbooks/pro_trading_workbook_template.md`
...
- `notes/finance-trading/foundations/Fundamental Analysis.md`
- `notes/finance-trading/workbooks/pro_trading_workbook_template.md`
...
- `notes/finance-trading/workbooks/professional_trading_workbook_methodology.md`
- `notes/finance-trading/workbooks/pro_trading_workbook_template.md`
...
| --- | --- | --- | --- |
| Too many setups too early | `notes/finance-trading/strategies/Positional Trader.md` | Medium | Start with two setups only |
| Undefined confirmation | `notes/finance-trading/strategies/Positional Trader.md`, `notes/finance-trading/foundations/Financial Jargon Glossary.md` | High | Replace with exact triggers |
| Subjective trade scoring | `notes/finance-trading/strategies/Probabilistic Trading Guide.md` | Medium | Calibrate score with journal data |
| No evidence layer | Workspace-wide | Critical | Build journal, replay, paper sample |
| Derivative complexity | `notes/finance-trading/foundations/Fundamental Analysis.md`, `notes/finance-trading/strategies/Positional Trader.md`, `personal/planning/Todo's.md` | High/Critical | Require instrument-level specs |
| Bot before validated strategy | AWS bot checklists | High | Build simulator and risk engine first |
| Possible false precision in valuation | `notes/finance-trading/foundations/Fundamental Analysis.md` | Medium | Use ranges and sensitivity tables |
| Glossary mistaken for skill | `notes/finance-trading/foundations/Financial Jargon Glossary.md` | Low/Medium | Tie each term to mechanism and decision |
| Paper trading without fill assumptions | Bot checklists | High | Model spread, slippage, rejected fills |
| Option selling mode | `personal/planning/Todo's.md` | Critical | Use defined-risk only, no naked selling |
...
| File | Purpose |
| --- | --- |
| `notes/finance-trading/governance/trading_notes_audit_report.md` | Final institutional-style audit report |
| `notes/finance-trading/governance/misunderstanding_register.md` | Register of weak, incomplete, or dangerous ideas |
| `notes/finance-trading/workbooks/pro_trading_workbook_template.md` | Practical workbook templates |
| `notes/finance-trading/workbooks/professional_trading_workbook_methodology.md` | How serious traders structure workbooks |
| `notes/finance-trading/governance/action_plan.md` | 7-day, 30-day, 60-day, and 90-day improvement plan |
