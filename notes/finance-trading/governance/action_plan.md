...
```text
1. Read `notes/finance-trading/strategies/Positional Trader.md`.
2. Read `notes/finance-trading/strategies/Probabilistic Trading Guide.md`.
3. Review `notes/finance-trading/governance/misunderstanding_register.md`.
4. Choose only two setups:
   - Trend Pullback Continuation
   - Base Breakout
5. Create a watchlist of liquid stocks only.
6. Create a trade journal using `notes/finance-trading/workbooks/pro_trading_workbook_template.md`.
