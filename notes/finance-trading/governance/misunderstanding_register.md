...
| --- | --- |
| Topic | Breakouts |
| Source | `notes/finance-trading/strategies/Positional Trader.md`, `notes/finance-trading/strategies/Probabilistic Trading Guide.md`, `notes/finance-trading/foundations/Financial Jargon Glossary.md` |
...
| Severity | High |
| How to fix it | Use the stricter Base Breakout rules now integrated into `notes/finance-trading/strategies/Positional Trader.md`, then record trades using `notes/finance-trading/workbooks/pro_trading_workbook_template.md`. |
...
| Source | `notes/finance-trading/strategies/Positional Trader.md` |
...
| Source | `notes/finance-trading/strategies/Probabilistic Trading Guide.md` |
...
| Source | `notes/finance-trading/foundations/Fundamental Analysis.md` |
...
| --- | --- |
| Topic | Futures |
| Source | `notes/finance-trading/foundations/Fundamental Analysis.md`, `notes/finance-trading/strategies/Positional Trader.md` |
...
| Source | `personal/planning/Todo's.md` |
...
| --- | --- |
| Topic | Paper trading |
| Source | `notes/finance-trading/study-plans/aws_saa_trading_bot_plan_checklist.md`, `notes/finance-trading/study-plans/aws_saa_trading_bot_plan_checklist_v2.md`, `notes/finance-trading/strategies/Positional Trader.md` |
