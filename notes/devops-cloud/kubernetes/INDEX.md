...
Started from the `_System/Instructions/master-subject-prompts.md` scope on 2026-05-26 and expanded on 2026-05-27. Core architecture coverage now includes desired state, control plane internals, Pod lifecycle, scheduling, networking/DNS, storage/CSI, security/RBAC/admission, failure-mode flowcharts, cheatsheet, and glossary. Future additions can deepen cluster upgrade, autoscaling, Gateway API controller-specific behavior, and provider-specific CNI/CSI labs.
